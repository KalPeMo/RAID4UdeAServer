...
with open(csv_file, mode='a', newline='') as file:
    ...
    for file_size in file_sizes:
        for block_size in block_sizes:
            ...
            command = f"iozone -a -i 0 -i 1 -s {file_size} -t {block_size} -f {disk}"
            ...
            read_speed = re.findall(r'Read:\s+([0-9]+\.[0-9]+)\s+B/sec', output)[0]
            write_speed = re.findall(r'Write:\s+([0-9]+\.[0-9]+)\s+B/sec', output)[0]
