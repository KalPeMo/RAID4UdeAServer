...
def write_to_csv(data):
    with open('iozone_results16.csv', 'a', newline='') as csvfile:
...
def run_experiment(file_size, record_size, chunk_size, replicas, experiment_number, total_experiments, disk):
    for replica in range(replicas):
        ...
        write_to_csv(['iozone', disk, experiment_number, replica+1, file_size, record_size] + last_6_numbers + [difference, time_test])
